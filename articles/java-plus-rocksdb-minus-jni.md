...
### AI-driven since day 1

This is also my first "AI project": I started it by writing the `CLAUDE.md` and
`AGENTS.md` files, most of the code is generated by AI. Code is structured to be friendly to new developers, either humans or AI agents.
...
CompactionFilter, WAL Iterator, Rate Limiter, etc.
...
part was not FFM — it was building RocksDB itself. `zig` has a very nice cross-compilation
toolchain, yet to be tested on Windows though.
