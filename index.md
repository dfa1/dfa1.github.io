---
layout: default
title: Davide Angelocola
description: Homepage of Davide Angelocola
...
Tech Lead & Senior Software Engineer, focused on distributed systems, data pipelines, and
operational reliability — with a strong emphasis on architecture and secure‑by‑design principles.

My GPG public key: [DAAAD56F0AA0B8F2](gpgkey.asc)

## Web presence

- [@github](https://github.com/dfa1)
- [@stackoverflow](https://stackoverflow.com/users/89266/dfa)
- [@linkedin](https://www.linkedin.com/in/davide-angelocola-079961142)
...
- [The Cost of Implicitness](articles/the-cost-of-implicitness.html) (2026)
- [From BPF to eBPF, Twenty Years Later](articles/from-bpf-to-ebpf-twenty-years-later.html) (2026)
- [Java + RocksDB - JNI](articles/java-plus-rocksdb-minus-jni.html) (2026)
- [The Joy of Proper Encapsulation](articles/the-joy-of-proper-encapsulation.html) (2026)
- [Coding With Claude Code](articles/coding-with-claude-code.html) (2026)
- [Decouple Allocations from Request Volume](articles/decouple-allocations-from-request-volume.html) (2023)
- [Make the Implicit Explicit](articles/make-the-implicit-explicit.html) (2022)
- [Your compiler is already part of your Security Team](articles/your-compiler-is-already-part-of-your-security-team.html) (2021)
- [Write Down The Why](articles/write-down-the-why.html) (2020)
- [The Slow Fix](articles/the-slow-fix.html) (2018)
...
- [Webapp made simple](https://dfa1.github.io/exmeeting-webapp-made-simple/), [@exmachina.ch](https://exmachina.ch) (2015)
- [Infrastructure as code with Puppet](https://dfa1.github.io/exmeeting-infrastructure-as-code-with-puppet), [@exmachina.ch](https://exmachina.ch) (2014)
...
- [pangolin](https://github.com/dfa1/pangolin), a sniffer written to learn raw sockets and some BPF filters in C (2004)
- [Sem](https://github.com/dfa1/sem), an [abstract semantic processor](https://halfgeek.org/wiki/SIMPLESEM) in C (2004)
